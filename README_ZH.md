...
| # | 项目 | ⭐ | 📈 日增 | 描述 |
|:-:|------|---:|-------:|------|
| 1 | [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 129,700 | +239 | 完整增强代码,克劳德代码,克鲁利,代码Buddy,彗星,课程,德文AI,朱尼,基罗,Leap.new... |
| 2 | [github/awesome-copilot](https://github.com/github/awesome-copilot) | 24,251 | +139 | 社区贡献的指令、提示和配置，帮助您充分利用GitHub Copilot。 |
| 3 | [liyupi/ai-guide](https://github.com/liyupi/ai-guide) | 9,278 | +71 | 程序员鱼皮的AI 资源大全 + 振动编码 零基础教程,分享大模型选择指南(DeepSeek / GP... |
| 4 | [fjb040911/ai-rules](https://github.com/fjb040911/ai-rules) | 93 | +50 | ai-rules是一个旨在解决人工智能驱动开发的"建筑衰退"的治理框架.它迫使人工智能代理 (Cur... |
| 5 | [Piebald-AI/claude-code-system-prompts](https://github.com/Piebald-AI/claude-code-system-prompts) | 5,553 | +49 | 所有部分的CLAUDE Code系统提示,18个构建工具描述,子代理提示 (计划/探索/任务),实用... |
| 6 | [prompt-security/clawsec](https://github.com/prompt-security/clawsec) | 674 | +39 | 保护你的SOUL.md (等) 通过漂移检测,现场安全建议,自动审计和技能完整性验证.所有这些都从一... |
| 7 | [MrLesk/Backlog.md](https://github.com/MrLesk/Backlog.md) | 5,069 | +28 | 后载.md - 在 Git 生态系统中管理人类和人工智能代理人之间的项目合作工具 |
| 8 | [GCWing/BitFun](https://github.com/GCWing/BitFun) | 291 | +26 | BitFun是一个代理开发环境（ADE，AI IDE），具有前沿的代码代理系统，包含四种模式——代理... |
| 9 | [elder-plinius/CL4R1T4S](https://github.com/elder-plinius/CL4R1T4S) | 13,106 | +20 | 泄露的系统提示:CHATGPT,GEMINI,GROK,CLAUDE,PERPLEXITY,CURS... |
| 10 | [mergisi/awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) | 155 | +20 | Curated list of AI agent templates for OpenClaw. R... |
| 11 | [PatrickJS/awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) | 38,333 | +18 | 📄 通过自定义规则和行为增强Cursor AI编辑器体验的配置文件 |
| 12 | [wasp-lang/open-saas](https://github.com/wasp-lang/open-saas) | 13,510 | +18 | A 100% free modern JS SaaS boilerplate (React, Nod... |
| 13 | [microsoft/skills](https://github.com/microsoft/skills) | 1,660 | +15 | 技能、MCP服务器、自定义代理、用于SDK以落地编码代理的Agents.md |
| 14 | [refly-ai/refly](https://github.com/refly-ai/refly) | 6,940 | +14 | 首个开源代理技能构建器。通过氛围工作流定义技能，在Claude Code、Cursor、Codex等... |
| 15 | [twostraws/SwiftAgents](https://github.com/twostraws/SwiftAgents) | 979 | +13 | An AGENTS.md file for Swift and SwiftUI projects. |
| 16 | [microsoft/hve-core](https://github.com/microsoft/hve-core) | 838 | +13 | A refined collection of Hypervelocity Engineering ... |
| 17 | [Mizoreww/awesome-claude-code-config](https://github.com/Mizoreww/awesome-claude-code-config) | 92 | +13 | 制作准备的Claude Code配置,自进循环,多语言规则,MCP集成和定制技能 |
| 18 | [intellectronica/ruler](https://github.com/intellectronica/ruler) | 2,529 | +6 | Ruler — apply the same rules to all coding agents |
| 19 | [liyupi/yu-ai-agent](https://github.com/liyupi/yu-ai-agent) | 1,786 | +6 | 编程导航 2025 年 AI 开发实战新项目，基于 Spring Boot 3 + Java 21 ... |
| 20 | [xu-xiang/everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh) | 95 | +6 | everything-claude-code 中文翻译项目：完整的 Claude Code 配置集合... |
...
<p align="center"><sub>✨ 自动整理 · 2026-03-09 20:23:33</sub></p>
