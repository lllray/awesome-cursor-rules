...
| # | 项目 | ⭐ | 📈 日增 | 描述 |
|:-:|------|---:|-------:|------|
| 1 | [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 127,787 | +284 | 完整增强代码,克劳德代码,克鲁利,代码Buddy,彗星,课程,德文AI,朱尼,基罗,Leap.new... |
| 2 | [github/awesome-copilot](https://github.com/github/awesome-copilot) | 23,537 | +176 | 社区贡献的指令、提示和配置，帮助您充分利用GitHub Copilot。 |
| 3 | [liyupi/ai-guide](https://github.com/liyupi/ai-guide) | 8,903 | +130 | 程序员鱼皮的AI 资源大全 + 振动编码 零基础教程,分享大模型选择指南(DeepSeek / GP... |
| 4 | [Piebald-AI/claude-code-system-prompts](https://github.com/Piebald-AI/claude-code-system-prompts) | 5,293 | +59 | 所有部分的CLAUDE Code系统提示,18个构建工具描述,子代理提示 (计划/探索/任务),实用... |
| 5 | [gadievron/raptor](https://github.com/gadievron/raptor) | 1,375 | +32 | Raptor将Claude Code转变为通用AI攻防安全代理。通过使用Claude.md并创建规则... |
| 6 | [GCWing/BitFun](https://github.com/GCWing/BitFun) | 291 | +26 | BitFun是一个代理开发环境（ADE，AI IDE），具有前沿的代码代理系统，包含四种模式——代理... |
| 7 | [PatrickJS/awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) | 38,234 | +25 | 📄 通过自定义规则和行为增强Cursor AI编辑器体验的配置文件 |
| 8 | [MrLesk/Backlog.md](https://github.com/MrLesk/Backlog.md) | 4,957 | +21 | 后载.md - 在 Git 生态系统中管理人类和人工智能代理人之间的项目合作工具 |
| 9 | [refly-ai/refly](https://github.com/refly-ai/refly) | 6,898 | +15 | 首个开源代理技能构建器。通过氛围工作流定义技能，在Claude Code、Cursor、Codex等... |
| 10 | [liyupi/yu-ai-agent](https://github.com/liyupi/yu-ai-agent) | 1,748 | +15 | 编程导航 2025 年 AI 开发实战新项目，基于 Spring Boot 3 + Java 21 ... |
| 11 | [microsoft/skills](https://github.com/microsoft/skills) | 1,603 | +15 | 技能、MCP服务器、自定义代理、用于SDK以落地编码代理的Agents.md |
| 12 | [mergisi/awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) | 84 | +14 | Curated list of AI agent templates for OpenClaw. R... |
| 13 | [awslabs/aidlc-workflows](https://github.com/awslabs/aidlc-workflows) | 548 | +12 | AI-Driven Life Cycle (AI-DLC) adaptive workflow st... |
| 14 | [enulus/OpenPackage](https://github.com/enulus/OpenPackage) | 416 | +10 | 开放,通用,编码代理技能,代理,规则,命令组织者和包管理者. |
| 15 | [prompt-security/clawsec](https://github.com/prompt-security/clawsec) | 570 | +9 | 保护你的SOUL.md (等) 通过漂移检测,现场安全建议,自动审计和技能完整性验证.所有这些都从一... |
| 16 | [wasp-lang/open-saas](https://github.com/wasp-lang/open-saas) | 13,476 | +8 | A 100% free modern JS SaaS boilerplate (React, Nod... |
| 17 | [GPTomics/bioSkills](https://github.com/GPTomics/bioSkills) | 305 | +7 | a set of SKILLS.md for doing bioinformatics with a... |
| 18 | [Piebald-AI/tweakcc](https://github.com/Piebald-AI/tweakcc) | 1,223 | +6 | 定制Claude Code的系统提示，创建自定义工具集、输入模式高亮器、主题/思考动词/旋转器，定制... |
| 19 | [fcakyon/claude-codex-settings](https://github.com/fcakyon/claude-codex-settings) | 448 | +6 | My personal Claude Code and OpenAI Codex setup wit... |
| 20 | [josix/awesome-claude-md](https://github.com/josix/awesome-claude-md) | 137 | +6 | Curated collection of exemplary claude.md files an... |
...
<p align="center"><sub>✨ 自动整理 · 2026-03-04 22:12:28</sub></p>
