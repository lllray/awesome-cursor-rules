...
| # | 项目 | ⭐ | 📈 日增 | 描述 |
|:-:|------|---:|-------:|------|
| 1 | [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 129,461 | +274 | 完整增强代码,克劳德代码,克鲁利,代码Buddy,彗星,课程,德文AI,朱尼,基罗,Leap.new... |
| 2 | [microsoft/hve-core](https://github.com/microsoft/hve-core) | 825 | +160 | A refined collection of Hypervelocity Engineering ... |
| 3 | [github/awesome-copilot](https://github.com/github/awesome-copilot) | 24,112 | +96 | 社区贡献的指令、提示和配置，帮助您充分利用GitHub Copilot。 |
| 4 | [liyupi/ai-guide](https://github.com/liyupi/ai-guide) | 9,207 | +54 | 程序员鱼皮的AI 资源大全 + 振动编码 零基础教程,分享大模型选择指南(DeepSeek / GP... |
| 5 | [Piebald-AI/claude-code-system-prompts](https://github.com/Piebald-AI/claude-code-system-prompts) | 5,504 | +52 | 所有部分的CLAUDE Code系统提示,18个构建工具描述,子代理提示 (计划/探索/任务),实用... |
| 6 | [prompt-security/clawsec](https://github.com/prompt-security/clawsec) | 635 | +41 | 保护你的SOUL.md (等) 通过漂移检测,现场安全建议,自动审计和技能完整性验证.所有这些都从一... |
| 7 | [GCWing/BitFun](https://github.com/GCWing/BitFun) | 291 | +26 | BitFun是一个代理开发环境（ADE，AI IDE），具有前沿的代码代理系统，包含四种模式——代理... |
| 8 | [Mizoreww/awesome-claude-code-config](https://github.com/Mizoreww/awesome-claude-code-config) | 79 | +24 | 制作准备的Claude Code配置,自进循环,多语言规则,MCP集成和定制技能 |
| 9 | [MrLesk/Backlog.md](https://github.com/MrLesk/Backlog.md) | 5,041 | +17 | 后载.md - 在 Git 生态系统中管理人类和人工智能代理人之间的项目合作工具 |
| 10 | [PatrickJS/awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) | 38,315 | +15 | 📄 通过自定义规则和行为增强Cursor AI编辑器体验的配置文件 |
| 11 | [mergisi/awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) | 135 | +12 | Curated list of AI agent templates for OpenClaw. R... |
| 12 | [microsoft/skills](https://github.com/microsoft/skills) | 1,645 | +9 | 技能、MCP服务器、自定义代理、用于SDK以落地编码代理的Agents.md |
| 13 | [Piebald-AI/tweakcc](https://github.com/Piebald-AI/tweakcc) | 1,261 | +9 | 定制Claude Code的系统提示，创建自定义工具集、输入模式高亮器、主题/思考动词/旋转器，定制... |
| 14 | [twostraws/SwiftAgents](https://github.com/twostraws/SwiftAgents) | 966 | +8 | An AGENTS.md file for Swift and SwiftUI projects. |
| 15 | [awslabs/aidlc-workflows](https://github.com/awslabs/aidlc-workflows) | 625 | +7 | AI-Driven Life Cycle (AI-DLC) adaptive workflow st... |
| 16 | [gadievron/raptor](https://github.com/gadievron/raptor) | 1,443 | +6 | Raptor将Claude Code转变为通用AI攻防安全代理。通过使用Claude.md并创建规则... |
| 17 | [aakashg/pm-claude-code-setup](https://github.com/aakashg/pm-claude-code-setup) | 40 | +6 | 准备使用CLAUDE.md和使用CLAUDE Code的产品管理人员的启动技能. |
| 18 | [liyupi/yu-ai-agent](https://github.com/liyupi/yu-ai-agent) | 1,780 | +5 | 编程导航 2025 年 AI 开发实战新项目，基于 Spring Boot 3 + Java 21 ... |
| 19 | [doramirdor/NadirClaw](https://github.com/doramirdor/NadirClaw) | 271 | +5 | Smart LLM router that cuts AI costs by ~40%. Route... |
| 20 | [EliFuzz/awesome-system-prompts](https://github.com/EliFuzz/awesome-system-prompts) | 120 | +5 | A collection of system prompts and tool definition... |
...
<p align="center"><sub>✨ 自动整理 · 2026-03-08 21:51:35</sub></p>
